  ...
  React.createClass
    ...
    componentDidMount: ->
      ...
      @node.tinymce
        ...
        toolbar: "undo redo | bold italic strikethrough underline | aligncenter alignjustify alignleft alignright indent outdent | subscript superscript | numlist bullist | link unlink | hr image table pastetext | code"
        plugins: 'paste link hr image table code'
        paste_as_text: true
        setup: (editor) =>
