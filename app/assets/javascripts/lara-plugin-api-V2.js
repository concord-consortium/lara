...
exports.pluginClasses = {};
/** @hidden */
exports.plugins = [];
/** @hidden */
exports.pluginLabels = [];
/** @hidden */
exports.pluginStatePaths = {};
...
exports.initPlugin = function (label, runtimeContext, pluginStatePath) {
    var constructor = exports.pluginClasses[label];
    var plugin = null;
    if (typeof constructor === "function") {
        try {
            plugin = new constructor(runtimeContext);
            exports.plugins.push(plugin);
            exports.pluginLabels.push(label);
            exports.pluginStatePaths[runtimeContext.pluginId] = pluginStatePath;
        }
        catch (e) {
...
exports.saveLearnerPluginState = function (pluginId, state) {
    var paths = exports.pluginStatePaths[pluginId];
...
exports.registerPlugin = function (label, _class) {
    ...
    if (exports.pluginClasses[label]) {
        // tslint:disable-next-line:no-console
        console.error("Duplicate Plugin for label", label);
        return false;
    }
    else {
        exports.pluginClasses[label] = _class;
        return true;
    }
};
