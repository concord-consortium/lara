...
Object.defineProperty(exports, "__esModule", { value: true });
var iframePhone = __webpack_require__(/*! iframe-phone */ "./src/interactive-api/node_modules/iframe-phone/main.js");
...
var IFrameSaver = /** @class */ (function () {
    ...
    IFrameSaver.prototype.phoneAnswered = function () {
        ...
        this.iframePhone.addListener("setLearnerUrl", function (learnerUrl) {
            _this.saveLearnerUrl(learnerUrl);
        });
        this.iframePhone.addListener("interactiveState", function (interactiveJson) {
            _this.saveLearnerState(interactiveJson);
        });
        this.iframePhone.addListener("getAuthInfo", function () {
            var authInfo = {
            ...
            _this.iframePhone.post("authInfo", authInfo);
        });
        this.iframePhone.addListener("height", function (height) {
            _this.$iframe.data("height", height);
            _this.$iframe.trigger("sizeUpdate");
        });
        this.iframePhone.addListener("supportedFeatures", function (info) {
        ...
        this.iframePhone.addListener("navigation", function (opts) {
            if (opts == null) {
                opts = {};
            }
        ...
        this.iframePhone.addListener("getFirebaseJWT", function (opts) {
            if (opts == null) {
                opts = {};
            }
            ...
            success: function (response) {
                if (response.raw_data) {
                    ...
                    if (interactive) {
                        ...
                        _this.iframePhone.post({ type: "loadInteractive", content: interactive });
    ...
    IFrameSaver.prototype.getFirebaseJwt = function (opts) {
        ...
        return $.ajax({
            ...
            data: opts,
            success: function (response) {
                _this.iframePhone.post("firebaseJWT", response);
            },
            error: function (jqxhr, status, error) {
                _this.iframePhone.post("firebaseJWT", { response_type: "ERROR", message: error });
            }
        });
    };
...
/***/ "./src/interactive-api/node_modules/iframe-phone/lib/iframe-endpoint.js":
/*!******************************************************************************!*\
  !*** ./src/interactive-api/node_modules/iframe-phone/lib/iframe-endpoint.js ***!
  \******************************************************************************/
/*! no static exports found */
...
var structuredClone = __webpack_require__(/*! ./structured-clone */ "./src/interactive-api/node_modules/iframe-phone/lib/structured-clone.js");
...
/***/ "./src/interactive-api/node_modules/iframe-phone/lib/iframe-phone-rpc-endpoint.js":
/*!****************************************************************************************!*\
  !*** ./src/interactive-api/node_modules/iframe-phone/lib/iframe-phone-rpc-endpoint.js ***!
  \****************************************************************************************/
/*! no static exports found */
...
var ParentEndpoint = __webpack_require__(/*! ./parent-endpoint */ "./src/interactive-api/node_modules/iframe-phone/lib/parent-endpoint.js");
var getIFrameEndpoint = __webpack_require__(/*! ./iframe-endpoint */ "./src/interactive-api/node_modules/iframe-phone/lib/iframe-endpoint.js");
...
/***/ "./src/interactive-api/node_modules/iframe-phone/lib/parent-endpoint.js":
/*!******************************************************************************!*\
  !*** ./src/interactive-api/node_modules/iframe-phone/lib/parent-endpoint.js ***!
  \******************************************************************************/
/*! no static exports found */
...
/***/ "./src/interactive-api/node_modules/iframe-phone/lib/structured-clone.js":
/*!*******************************************************************************!*\
  !*** ./src/interactive-api/node_modules/iframe-phone/lib/structured-clone.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
/***/ "./src/interactive-api/node_modules/iframe-phone/main.js":
/*!***************************************************************!*\
  !*** ./src/interactive-api/node_modules/iframe-phone/main.js ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = {
   ...
   */
  ParentEndpoint:  __webpack_require__(/*! ./lib/parent-endpoint */ "./src/interactive-api/node_modules/iframe-phone/lib/parent-endpoint.js"),
  /**
   * Allows to communicate with a parent page.
   * IFrameEndpoint is a singleton, as iframe can't have multiple parents anyway.
   */
  getIFrameEndpoint: __webpack_require__(/*! ./lib/iframe-endpoint */ "./src/interactive-api/node_modules/iframe-phone/lib/iframe-endpoint.js"),
  structuredClone: __webpack_require__(/*! ./lib/structured-clone */ "./src/interactive-api/node_modules/iframe-phone/lib/structured-clone.js"),

  // TODO: May be misnamed
  IframePhoneRpcEndpoint: __webpack_require__(/*! ./lib/iframe-phone-rpc-endpoint */ "./src/interactive-api/node_modules/iframe-phone/lib/iframe-phone-rpc-endpoint.js")
