...
/***/ "../../iframe-phone/lib/iframe-endpoint.js":
/*!***************************************************************!*\
  !*** /home/doug/projects/iframe-phone/lib/iframe-endpoint.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var structuredClone = __webpack_require__(/*! ./structured-clone */ "../../iframe-phone/lib/structured-clone.js");
...
/***/ "../../iframe-phone/lib/iframe-phone-rpc-endpoint.js":
/*!*************************************************************************!*\
  !*** /home/doug/projects/iframe-phone/lib/iframe-phone-rpc-endpoint.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var ParentEndpoint = __webpack_require__(/*! ./parent-endpoint */ "../../iframe-phone/lib/parent-endpoint.js");
var getIFrameEndpoint = __webpack_require__(/*! ./iframe-endpoint */ "../../iframe-phone/lib/iframe-endpoint.js");
...
/***/ "../../iframe-phone/lib/parent-endpoint.js":
/*!***************************************************************!*\
  !*** /home/doug/projects/iframe-phone/lib/parent-endpoint.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../iframe-phone/lib/structured-clone.js":
/*!****************************************************************!*\
  !*** /home/doug/projects/iframe-phone/lib/structured-clone.js ***!
  \****************************************************************/
/*! no static exports found */
...
/***/ "../../iframe-phone/main.js":
/*!************************************************!*\
  !*** /home/doug/projects/iframe-phone/main.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = {
   ...
   */
  ParentEndpoint:  __webpack_require__(/*! ./lib/parent-endpoint */ "../../iframe-phone/lib/parent-endpoint.js"),
  /**
   * Allows to communicate with a parent page.
   * IFrameEndpoint is a singleton, as iframe can't have multiple parents anyway.
   */
  getIFrameEndpoint: __webpack_require__(/*! ./lib/iframe-endpoint */ "../../iframe-phone/lib/iframe-endpoint.js"),
  structuredClone: __webpack_require__(/*! ./lib/structured-clone */ "../../iframe-phone/lib/structured-clone.js"),

  // TODO: May be misnamed
  IframePhoneRpcEndpoint: __webpack_require__(/*! ./lib/iframe-phone-rpc-endpoint */ "../../iframe-phone/lib/iframe-phone-rpc-endpoint.js")
...
Object.defineProperty(exports, "__esModule", { value: true });
var iframePhone = __webpack_require__(/*! iframe-phone */ "../../iframe-phone/main.js");
var LaraInteractiveApi;
(function (LaraInteractiveApi) {
    var verbosityLevels = {
        error: 0,
        warning: 1,
        info: 2,
    ...
    var Client = /** @class */ (function () {
        ...
        Client.GetLocalVerbosityLevel = function (name) {
            var level = window.localStorage.getItem("LaraInteractiveApiVerbosity[" + name + "]") ||
                ...
                if (!this.phone) {
                    ...
                    this.addListener("getLearnerUrl", function () {
                        if (_this.options.onGetLearnerUrl) {
                            ...
                            _this.log("debug", "getLearnerUrl listener called, client returned:", learnerUrl);
                            _this.setLearnerUrl(learnerUrl);
                        }
                        else {
                            _this.log("debug", "getLearnerUrl listener called, no client callback found");
                        }
                    });
                    this.addListener("getInteractiveState", function () {
                        if (_this.options.onGetInteractiveState) {
                            var interactiveState = _this.options.onGetInteractiveState();
                            _this.log("debug", "getInteractiveState listener called, client returned:", interactiveState);
                            _this.setInteractiveState(interactiveState);
                        }
                        else {
                    ...
                    function (initMessage) {
                        if (_this.options.onInitInteractive) {
                            ...
                            _this.log("debug", "initInteractive listener called, no client callback found");
                        }
                    });
                    this.addListener("loadInteractive", function (interactiveState) {
                        if (_this.options.onLoadInteractive) {
                            _this.log("debug", "loadInteractive listener called, calling client callback");
                            _this.options.onLoadInteractive(interactiveState);
                        }
                        else {
        ...
        Object.defineProperty(Client.prototype, "inIFrame", {
            get: function () {
                return inIframe;
            },
            enumerable: true,
        ...
        Client.prototype.setLearnerUrl = function (url) {
            return this.post("setLearnerUrl", url);
        };
        Client.prototype.setInteractiveState = function (interactiveState) {
        ...
        Client.prototype.setSupportedFeatures = function (supportedFeatures) {
        ...
        Client.prototype.getAuthInfo = function () {
            ...
            return new Promise(function (resolve, reject) {
                if (!_this.phone) {
                    _this.log("debug", "#getAuthInfo: this.phone undefined");
                    return reject("Not in iframe");
                }
                var listener = function (authInfo) {
                    resolve(authInfo);
                    _this.removeListener("authInfo");
                };
                _this.addListener("authInfo", listener);
                _this.post("getAuthInfo");
            });
        };
        Client.prototype.getFirebaseJWT = function (options) {
            var _this = this;
            return new Promise(function (resolve, reject) {
                if (!_this.phone) {
                    _this.log("debug", "#getFirebaseJWT: this.phone undefined");
                    return reject("Not in iframe");
                }
                var listener = function (response) {
                    ...
                    _this.removeListener("firebaseJWT");
                };
                _this.addListener("firebaseJWT", listener);
                _this.post("getFirebaseJWT", options);
            });
        };
        ...
        Client.prototype.addListener = function (message, listener) {
            if (this.phone) {
        ...
        Client.prototype.removeListener = function (message) {
            if (this.phone) {
        ...
        Client.prototype.log = function (level) {
            ...
            var _a = this.options, name = _a.name, verbosity = _a.verbosity;
            if (verbosity && (verbosityLevels[level] <= verbosityLevels[verbosity])) {
                // tslint:disable-next-line:no-console
                var logger = level === "error" ? console.error : (level === "warning" ? console.warn : console.info);
                logger.apply(this, ["[" + level + "]: " + name].concat(args));
            }
        };
        return Client;
    }());
    LaraInteractiveApi.Client = Client;
})(LaraInteractiveApi = exports.LaraInteractiveApi || (exports.LaraInteractiveApi = {}));
...
__export(__webpack_require__(/*! ../interactive-api-client */ "./src/interactive-api-client/index.ts"));
