...
exports.ManagedInteractiveAuthoring = function (props) {
    ...
    react_1.useEffect(function () {
        $.getJSON("/library_interactives")
            .done(function (libraryInteractives) {
            setState({
                current: "loaded",
                libraryInteractives: libraryInteractives,
    ...
    var selectOptions = state.libraryInteractives.map(function (li) { return ({ value: li.id, label: li.name }); });
    var handleSelectChange = function (selectedOption) {
        setState(__assign({}, state, { selectedOption: selectedOption }));
    ...
    return (React.createElement("fieldset", null,
        React.createElement("legend", null, selectLegend),
        React.createElement("input", { type: "hidden", id: selectId, name: selectName, ref: hiddenRef }),
        React.createElement(react_select_1.default, { value: state.selectedOption, onChange: handleSelectChange, options: selectOptions })));
};
