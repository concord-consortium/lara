class LightweightActivity < ActiveRecord::Base
  ...
  def serialize_for_portal(host)
    ...
    visible_pages_with_embeddables.each do |page|
      if self.runtime == "Activity Player"
        page_url = serialized_ap_url(host, page: page, preview: true)
      else
  ...
  def serialize_for_report_service(host)
    ...
    if self.runtime == "Activity Player"
      data[:preview_url] = serialized_ap_url(host, preview: true)
    end
    ...
    visible_pages_with_embeddables.each do |page|
      ...
      if self.runtime == "Activity Player"
        page_data[:preview_url] = serialized_ap_url(host, page: page, preview: true)
      end
  ...
  def serialized_ap_url(host, page: nil, preview: false)
