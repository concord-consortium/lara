...
▸ **getAttachmentsManager**(): *Promise‹AttachmentsManager‹››*

**Returns:** *Promise‹AttachmentsManager‹››*

___

### `Const` handleGetAttachmentUrl

▸ **handleGetAttachmentUrl**(`options`: [IHandleGetAttachmentUrlOptions](interfaces/ihandlegetattachmenturloptions.md)): *Promise‹[IAttachmentUrlResponse](interfaces/iattachmenturlresponse.md)›*
...
**Returns:** *Promise‹[IAttachmentUrlResponse](interfaces/iattachmenturlresponse.md)›*

___

### `Const` initializeAttachmentsManager

▸ **initializeAttachmentsManager**(`options`: [IAttachmentsManagerInitOptions](interfaces/iattachmentsmanagerinitoptions.md)): *Promise‹void›*

**Parameters:**

Name | Type |
------ | ------ |
`options` | [IAttachmentsManagerInitOptions](interfaces/iattachmentsmanagerinitoptions.md) |

**Returns:** *Promise‹void›*

___

### `Const` setAttachmentsManagerTimeout

▸ **setAttachmentsManagerTimeout**(`timeInMs`: number): *void*
