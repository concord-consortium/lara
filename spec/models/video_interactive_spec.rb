...
describe VideoInteractive do
  ...
  describe '#to_hash' do
    it 'has useful values' do
      expected = { url: video_interactive.url, caption: video_interactive.caption, credit: video_interactive.credit }
  ...
  describe '#duplicate' do
    it 'is a new instance of VideoInteractive with values' do
      video_interactive.duplicate.should be_a_new(VideoInteractive).with( url: video_interactive.url, caption: video_interactive.caption, credit: video_interactive.credit )
    end
  end
end
