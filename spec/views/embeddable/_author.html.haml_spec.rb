...
describe "The standard authoring view of the labbook" do
  def warning_text
    Embeddable::Labbook::WONT_DISPLAY_MSG
  end

  let(:lb_stubs)      { {show_in_runtime?: false, action_label: 'appears on button' } }
  ...
  describe "When the labbook won't show in the runtime" do
    it "displays a warning message to authors" do
      render :partial => "embeddable/labbooks/author.html.haml", :locals => _locals
