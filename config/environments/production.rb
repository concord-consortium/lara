LightweightStandalone::Application.configure do
  ...
  # Themes:
  config.assets.precompile += %w(runtime-base.css theme-has-ngs.css theme-mw.css theme-has-ngs-atmosphere.css theme-has-ngs-climate.css theme-has-ngs-hydrofracking.css theme-has-ngs-landmanagement.css theme-has-ngs-water.css theme-rites.css print-summary.css theme-interactions-electrostatics.css theme-interactions.css theme-itsi.css)
