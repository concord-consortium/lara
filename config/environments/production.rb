LightweightStandalone::Application.configure do
  ...
  config.assets.precompile += %w( runtime.css theme-has-ngs.css theme-mw.css theme-has-ngs-atmosphere.css theme-has-ngs-climate.css theme-has-ngs-hydrofracking.css theme-has-ngs-landmanagement.css theme-has-ngs-water.css runtime.js respond.js)
