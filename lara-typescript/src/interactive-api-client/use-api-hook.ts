...
export function useLaraInteractiveApi<InteractiveState = {}, AuthoredState = {}, DialogState = {}, GlobalInteractiveState = {}>(hookOptions: IHookOptions) {
  ...
  useEffect(() => {
    client.current = new Client<InteractiveState, AuthoredState, DialogState, GlobalInteractiveState>({
