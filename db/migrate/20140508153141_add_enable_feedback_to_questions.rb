class AddEnableFeedbackToQuestions < ActiveRecord::Migration
  def change
    ...
    add_column :embeddable_open_responses, :prediction_feedback, :text, :default => ""
    add_column :embeddable_multiple_choices, :prediction_feedback, :text, :default => ""
    add_column :embeddable_image_questions, :prediction_feedback, :text, :default => ""
  end
end
