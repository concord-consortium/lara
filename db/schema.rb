...
ActiveRecord::Schema.define(:version => 20200727090406) do
  ...
  add_index "linked_page_items", ["primary_id", "secondary_id"], :name => "index_linked_page_items_unique", :unique => true
