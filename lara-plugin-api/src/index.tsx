...
const LARA = {
  /****************************************************************************
   ...
   in `onRemove` handler.
   ****************************************************************************/
  addPopup: function (options: IPopupOptions) {
   ...
   ****************************************************************************/
  addSidebar: function (options: ISidebarOptions) {
  ...
  /****************************************************************************
   ...
   @returns Promise
   ****************************************************************************/
  saveLearnerPluginState: function (pluginId: string, state: string) {
  ...
  /****************************************************************************
   ...
   @returns void
   ****************************************************************************/
  decorateContent: function (words: string[], replace: string, wordClass: string, listeners: IEve) {
   ...
   **************************************************************/
  registerPlugin: function(label: string, _class: any) {
